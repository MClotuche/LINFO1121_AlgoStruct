...
public class PreorderToBST2 {
    ...
    */
    ...
    public PreorderToBST2() {

    }

    public PreorderToBST2(Node r) {
        root = r;
    }
     ...
     */
    public PreorderToBST2(int [] preOrderInput) {
    ...
    public Node preorderRead(int [] preOrderInput, int i, int min, int max) {
        if (preOrderInput ==null)return null;
        if (i <preOrderInput.length && preOrderInput[i]>min && preOrderInput[i] <max){
            Node left = preorderRead(preOrderInput,i+1,min,preOrderInput[i]);
            Node right = preorderRead(preOrderInput,i+size(left)+1,preOrderInput[i],max);
    ...
    public boolean equals(Object obj) {
        ...
        // don't change it
        if (obj != null) {
            PreorderToBST2 other = ((PreorderToBST2) obj);
