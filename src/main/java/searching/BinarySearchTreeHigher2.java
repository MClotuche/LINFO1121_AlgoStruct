 ...
 *
 */
public class BinarySearchTreeHigher2<Key extends Comparable<Key>, Value> {
     ...
     */
    public BinarySearchTreeHigher2() {}
    ...
    private Key higherKey(Node x, Key key) {
        ...
        if (cmp>=0){//k >= kx
            ...
            if (concurrent == null || concurrent.compareTo(x.key) >= 0)return x.key;
